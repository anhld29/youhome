    ...
    <div class="header-layout">
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-brand view_pc-tab">Chúc mừng Quý khách ABC giao dịch thành công!</div>
    ...
    <div class="container">
        <div class="box-advance-search">
            ...
            <div class="box-tab">
                <div id="tab">
                    <ul>
                        <li data-target="#panel01" class="active">Mua </li>
                        <li data-target="#panel02">Thuê</li>
                    </ul>
                </div><!-- /#obj_tab -->
                <div id="panel">
